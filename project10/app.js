...
async function changeWeather(capital) {
    
    let apiURL = `https://api.openweathermap.org/data/2.5/weather?q=${capital}&appid=301d2e5a310dfd9506cbebd36fc8a346`
